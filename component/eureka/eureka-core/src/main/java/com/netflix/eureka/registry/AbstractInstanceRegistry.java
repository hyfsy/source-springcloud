...
public abstract class AbstractInstanceRegistry implements InstanceRegistry {
    ...
    private final MeasuredRate renewsLastMin; // 最后一分钟添加的实例数量
    ...
    protected AbstractInstanceRegistry(EurekaServerConfig serverConfig, EurekaClientConfig clientConfig, ServerCodecs serverCodecs) {
        ...
        this.renewsLastMin = new MeasuredRate(1000 * 60 * 1); // 每分钟更新注册实例数量
     ...
     * 驱逐心跳检测超时的节点实例
     *
     * @param additionalLeaseMs 额外的生存时间
     */
    ...
    /**
     * 将Lease包装还原为InstanceInfo中的LeaseInfo
     *
     * @param lease 租户包装的实例节点信息
     * @return 包含租户信息的实例节点
     */
