...
@Import({ HttpClientFeignLoadBalancerConfiguration.class, // apache-http
		OkHttpFeignLoadBalancerConfiguration.class, // ok-http
		HttpClient5FeignLoadBalancerConfiguration.class, // apache-hc5
		DefaultFeignLoadBalancerConfiguration.class }) // default HttpURLConnection
